...
Funcionalidade: Adicionar um novo processo.
    ...
    E o paciente digitar no campo "processo_vara" o valor "64"
    E o paciente digitar no campo "processo_numero_processo" o valor "123123"
    E o paciente digitar no campo "processo_natureza" o valor "Engenharia de Software"
    E o paciente digitar no campo "processo_partes" o valor "Daiane x Juliana"
    ...
    Então o paciente deveria ver o texto "Daiane x Juliana"

    @ignore
    Cenário: Ler um processo com sucesso
    Quando o paciente clicar no botão "btn-show_473" na página de inclusão de processos
    Então no campo vara deve mostrar o conteúdo "Vara: 64"
    E no campo numero processo deve mostrar o conteúdo "Numero processo: 123123"
